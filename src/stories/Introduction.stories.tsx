    ...
    <div style={storyStyles.container}>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', display: 'block', width: '70%' }}>
          ...
          <button
            onClick={() => {
              navigator.clipboard.writeText('npm install use-fetch-with-callbacks');
      ...
      <div style={{
        ...
        <ul style={{ paddingLeft: '0', lineHeight: '1.8', fontSize: '16px', listStyle: 'none' }}>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            ...
            <span><strong>Complete HTTP Methods</strong>: GET, POST, PUT, DELETE, PATCH support</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>Request Chaining</strong>: Sequential operations with chainable API</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>Callback Support</strong>: Success, error, and loading callbacks</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>Performance Optimized</strong>: Memory leak prevention and efficient state management</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>Type Safe</strong>: Full TypeScript support with generic types</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>Request Cancellation</strong>: Built-in AbortController support</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>Timeout Support</strong>: Configurable request timeouts</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>Concurrent Requests</strong>: Handle multiple simultaneous requests</span>
          </li>
          <li style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
            <div style={{
              width: '24px',
            ...
            <span><strong>State Management</strong>: Comprehensive loading, error, and response states</span>
          </li>
        </ul>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: '15px' }}>
            ...
            <h3 style={{ margin: 0, color: '#2d3748', fontSize: '20px', fontWeight: '600' }}>Type Safe</h3>
          </div>
          <p style={{ margin: 0, color: '#4a5568', lineHeight: '1.6' }}>Full TypeScript support with generic types for complete type safety and IntelliSense.</p>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: '15px' }}>
            ...
            <h3 style={{ margin: 0, color: '#2d3748', fontSize: '20px', fontWeight: '600' }}>Performance</h3>
          </div>
          <p style={{ margin: 0, color: '#4a5568', lineHeight: '1.6' }}>Optimized for performance with built-in memory leak prevention and efficient state management.</p>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: '15px' }}>
            ...
            <h3 style={{ margin: 0, color: '#2d3748', fontSize: '20px', fontWeight: '600' }}>Chainable</h3>
          </div>
          <p style={{ margin: 0, color: '#4a5568', lineHeight: '1.6' }}>Sequential operations with a fluent, chainable API for complex workflows.</p>
        </div>
      </div>
    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px' }}>
          ...
          <h2 style={{ margin: 0, fontSize: '28px', color: '#333' }}>Request Chaining</h2>
        </div>
        <pre style={{
          backgroundColor: '#f8f9fa',
          color: '#333',
  ...
  .execute();`}
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px' }}>
          ...
          <h2 style={{ margin: 0, fontSize: '28px', color: '#333' }}>HTTP Methods</h2>
        </div>
        <pre style={{
          backgroundColor: '#f8f9fa',
          color: '#333',
...
const { fetchData } = useFetchWithCallbacks<User>('/users/1', {
  ...
  timeout: 5000
      ...
      <div style={{
        ...
        <ul style={{ paddingLeft: '20px', lineHeight: '1.8', fontSize: '16px', color: '#666' }}>
