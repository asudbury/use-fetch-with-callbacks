try {
  (() => {
    var Je = __STORYBOOK_API__,
      {
        ...
        merge: pt,
        mockChannel: lt,
        optionOrAltSymbol: dt,
        shortcutMatchesShortcut: ut,
        shortcutToHumanString: ft,
        types: ct,
        useAddonState: gt,
        useArgTypes: bt,
        useArgs: ht,
    ...
    var jt = __STORYBOOK_CLIENT_LOGGER__,
      {
        deprecate: Rt,
        logger: L,
        once: Mt,
    ...
    function z(e) {
      ...
      return (
        (z = function (r) {
          ...
          function a() {
            return ne(r, arguments, A(this).constructor);
          }
          return (
...
`,
    ...
    var u = (function (e) {
      ...
      function t(r) {
        for (
          var a, n = arguments.length, o = new Array(n > 1 ? n - 1 : 0), i = 1;
          i < n;
          i++
        )
          o[i - 1] = arguments[i];
        return (
          (a = e.call(this, ie.apply(void 0, [oe[r]].concat(o))) || this),
          te(a)
        );
      }
      return t;
    ...
    function x(e, t, r, a) {
      if ((a === void 0 && (a = se), t === 0)) return a(r, r, r);
    ...
    function T(e) {
      ...
      var o = ce.exec(t.substring(0, 50));
      if (o)
        return {
          red: parseInt('' + o[1], 10),
      ...
      var f = be.exec(t.substring(0, 50));
      if (f) {
        var I = parseInt('' + f[1], 10),
          V = parseInt('' + f[2], 10) / 100,
          ee = parseInt('' + f[3], 10) / 100,
          N = 'rgb(' + x(I, V, ee) + ')',
          w = E.exec(N);
        if (!w) throw new u(4, t, N);
        return {
          red: parseInt('' + w[1], 10),
    ...
    function he(e) {
      ...
      return (
        (p *= 60),
        e.alpha !== void 0
          ? { hue: p, saturation: d, lightness: i, alpha: e.alpha }
          : { hue: p, saturation: d, lightness: i }
      );
    }
    function J(e) {
      return he(T(e));
    ...
    function ve(e, t, r) {
      ...
      if (typeof e == 'object' && t === void 0 && r === void 0)
        return k(e.hue, e.saturation, e.lightness);
      throw new u(1);
    }
    function Fe(e, t, r, a) {
      if (
        ...
        return a >= 1 ? k(e, t, r) : 'rgba(' + x(e, t, r) + ',' + a + ')';
      if (typeof e == 'object' && t === void 0 && r === void 0 && a === void 0)
        return e.alpha >= 1
          ? k(e.hue, e.saturation, e.lightness)
          : 'rgba(' + x(e.hue, e.saturation, e.lightness) + ',' + e.alpha + ')';
      throw new u(2);
    }
    function D(e, t, r) {
      if (typeof e == 'number' && typeof t == 'number' && typeof r == 'number')
        return H('#' + c(e) + c(t) + c(r));
      if (typeof e == 'object' && t === void 0 && r === void 0)
        return H('#' + c(e.red) + c(e.green) + c(e.blue));
      throw new u(6);
    }
    function S(e, t, r, a) {
    ...
    function ke(e, t) {
      ...
      var r = J(t);
      return Q(v({}, r, { lightness: B(0, 1, r.lightness - parseFloat(e)) }));
    }
    var Pe = O(ke),
      Te = Pe;
    function Oe(e, t) {
    ...
    function _e(e, t) {
      ...
      var r = T(t),
        ...
        n = v({}, r, { alpha: B(0, 1, (a * 100 + parseFloat(e) * 100) / 100) });
      return S(n);
    }
    var Gt = O(_e);
    function Ee(e, t) {
      ...
      var r = T(t),
        a = typeof r.alpha == 'number' ? r.alpha : 1,
        n = v({}, r, {
          alpha: B(0, 1, +(a * 100 - parseFloat(e) * 100).toFixed(2) / 100),
        });
      return S(n);
    }
    var je = O(Ee),
