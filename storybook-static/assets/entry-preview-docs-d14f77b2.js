...
import { R as at, r as We } from './index-8b3efc3f.js';
var _i = { exports: {} },
        ...
        return (
          ae(function () {
            (u.left.type === t.VariableDeclaration
              ...
              (l = U(l, n)),
              (l = [
                U(l, d.generateExpression(u.right, r.Assignment, M)),
                ')',
              ]));
          }),
            ...
            if (n.handler)
              if (Array.isArray(n.handler))
                ...
                ((o = U(o, this.generateStatement(n.handler, ee))),
                  n.finalizer &&
                    (o = this.maybeBlockSuffix(n.handler.body, o)));
          }
          return (
            n.finalizer &&
      ...
      (oe.Expression = {
        ...
        ImportSpecifier: function (n, u, o) {
          var l = n.imported,
            ...
            w = n.local;
          return (
            w && w.name !== l.name && d.push(fe() + 'as' + fe() + ge(w)),
            d
          );
        },
    ...
    if (this.regexp_eatFixedHexDigits(e, 4)) {
      ...
      if (i && s >= 55296 && s <= 56319) {
        ...
        if (e.eat(92) && e.eat(117) && this.regexp_eatFixedHexDigits(e, 4)) {
          ...
          if (c >= 56320 && c <= 57343)
            return (
              (e.lastIntValue = (s - 55296) * 1024 + (c - 56320) + 65536),
              !0
            );
        }
...
$.readRegexp = function () {
  ...
  (f.reset(r, s, c),
    this.validateRegExpFlags(f),
    this.validateRegExpPattern(f));
  var p = null;
  try {
    p = new RegExp(s, c);
  } catch {}
...
$.readHexChar = function (e) {
  var t = this.pos,
    r = this.readInt(16, e);
  return (
    r === null && this.invalidStringToken(t, 'Bad character escape sequence'),
    r
  );
};
$.readWord1 = function () {
...
var bu = (e, t) => {
    ...
    for (let a = 0; a < t.skip; a += 1) {
      if (typeof r > 'u')
        return (At.warn('Cannot skip undefined element'), null);
