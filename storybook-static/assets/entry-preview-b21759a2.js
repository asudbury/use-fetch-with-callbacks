import { R as o, r as i } from './index-8b3efc3f.js';
import { u as p, r as d } from './react-18-0a210e0b.js';
import './_commonjsHelpers-de833af9.js';
const { global: u } = __STORYBOOK_MODULE_GLOBAL__;
var { FRAMEWORK_OPTIONS: s } = u,
  x = (r, e) => {
    let { id: n, component: t } = e;
    if (!t)
      throw new Error(
...
async function _(
  ...
  let m = o.createElement(
      E,
      { showMain: n, showException: t },
      o.createElement(e, { ...r })
    ),
    h = c ? o.createElement(c, null, m) : m;
  return (l && p(a), await d(h, a), () => p(a));
}
var C = { renderer: 'react' };
export { C as parameters, x as render, _ as renderToCanvas };
