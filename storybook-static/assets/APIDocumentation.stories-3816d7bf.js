import { j as r, s as o } from './storyStyles-bf201a31.js';
...
`.trim(),
      c = l => {
        ...
        return (
          ...
          (e = e.replace(
            /`([^`]+)`/g,
            `<code style="background: #f1f5f9; color: #1e40af; padding: 0.2rem 0.4rem; border-radius: 3px; font-family: 'Consolas', 'Monaco', monospace;">$1</code>`
          )),
          (e = e.replace(
            /\*\*([^*]+)\*\*/g,
          ...
          (e = e.replace(/\n {2}/g, '<br/>{2}')),
          (e = '<p style="margin: 1rem 0; line-height: 1.6;">' + e + '</p>'),
          e
        );
      };
    return r.jsxs('div', {
      ...
      children: [
        r.jsxs('div', {
          style: o.gradientHeader,
          children: [
            r.jsx('h1', {
              style: o.gradientHeaderTitle,
              children: '📚 API Reference',
            }),
            r.jsx('p', {
              style: o.gradientHeaderSubtitle,
              children:
        ...
        r.jsx('div', {
          style: o.card,
          dangerouslySetInnerHTML: { __html: c(i) },
        }),
      ],
    });
  },
  p = { title: 'API Reference', parameters: { docs: { page: null } } },
  t = { render: () => r.jsx(d, {}), parameters: { layout: 'fullscreen' } };
var a, n, s;
t.parameters = {
  ...t.parameters,
  docs: {
  ...
  parameters: {
    layout: 'fullscreen'
      ...
      ...((s = (n = t.parameters) == null ? void 0 : n.docs) == null
        ? void 0
        : s.source),
    },
  },
};
const f = ['APIReference'];
export { t as APIReference, f as __namedExportsOrder, p as default };
